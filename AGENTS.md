# Arts and Sports Pupil’s Book Standard Five — ADT Bundle Reference
...
**Arts and Sports Pupil’s Book Standard Five** — This English-language pupil’s book, published by the Tanzania Institute of Education for Standard Five learners in mainland Tanzania, introduces arts and sports through practical, activity-based lessons suited to upper primary pupils. It covers acting and mime, singing and solfa, drawing, clay modelling, making useful objects from recycled materials, physical exercises, traditional games, and modern sports such as football and netball. The book emphasizes hands-on practice, creativity, skill development, teamwork, and links learning to everyday life, culture, health, and livelihood, reflecting a competency-based teaching approach.

- **Source language**: `en`
- **Available languages in this bundle**: `en`, `en-KE`
- **Total pages**: 219
- **Quizzes**: yes
- **Glossary**: yes
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: en, en-KE
...
├── ART---SPORTS-5-a-2.db                    # SQLite database (pipeline state)
├── ART---SPORTS-5-a-2.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania, Ministry of Education, Science and Technology, for the Arts and Sports Pupil’s Book Standard Five.",
  "gl001": "abdominal",
  "gl001_def": "related to the stomach area of the body",
  "qz001_que": "What is drama mainly used for?",
  "qz001_o0": "1) To grow crops",
  "qz001_o0_exp": "❌ Not correct. Growing crops is important work, but it is not what drama is mainly used for."
}
```
...
```json
{
  "abdominal": {
    "word": "abdominal",
    "definition": "related to the stomach area of the body",
    "variations": ["abdominal","abdomen"],
    "emoji": "🧍💪"
  }
}
```
...
```json
{
  "title": "Arts and Sports Pupil’s Book Standard Five",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en",
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is drama mainly used for?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not correct. Growing crops is important work, but it is not what drama is mainly used for." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) To grow crops</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ART---SPORTS-5-a-2.pdf` |
| Pipeline database | `ART---SPORTS-5-a-2.db` (SQLite) |
